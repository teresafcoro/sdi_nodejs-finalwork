...
const loginsRepository = require("../repositories/logsRepository");
...
const generateLogContent = async function (req, res) {
    ...
    if (req.query && Object.keys(req.query).length > 0) {
        ...
        logContent.description.params = Object.keys(allParams).map(key => {
            return {
    ...
    await loginsRepository.addNewLog(logContent);
}
